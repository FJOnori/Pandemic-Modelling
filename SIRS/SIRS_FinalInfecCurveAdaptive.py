...
class SIR_Model():
    ...
    def __init__(self, FinalTime=1500, dt=0.01, I_initial=0.0001, RecoveryRate=(1/10), ContactFactor=1) -> None:
    ...
    def NumInt(self):
        ...
        for b in np.linspace(self.ContactRateL,self.ContactRateH,5):
            ...
            for n in np.arange(0, self.iterations):
                ...
                elif I[n] <= self.popcut: beta = self.ContactRateH
    ...
    def Lineplot(self):
        ...
        plt.title("SIRS Adaptive Model, Population Cutoff - " + str(self.popcut))
